...
WebUI.setText(findTestObject('Object Repository/PerformanceTest/TimeClockRequestHistory/Page_HRMS/input_HRMS_username'), 
    'wwhHlaing')

WebUI.setEncryptedText(findTestObject('Object Repository/PerformanceTest/TimeClockRequestHistory/Page_HRMS/input_HRMS_password'), 
    'tR+yPLK5N5TO48zpsW01Kw==')

WebUI.click(findTestObject('Object Repository/PerformanceTest/TimeClockRequestHistory/Page_HRMS/button_Login'))
