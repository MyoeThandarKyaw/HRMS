...
WebUI.setEncryptedText(findTestObject('Object Repository/NewManualTimeClock_My_Direct_Report_by_HR_Manager/Page_HRMS/input_HRMS_password'), 
...
WebUI.click(findTestObject('Object Repository/NewManualTimeClock_My_Direct_Report_by_HR_Manager/Page_HRMS/p_Time Clock Requests'))
...
WebUI.click(findTestObject('Object Repository/NewManualTimeClock_My_Direct_Report_by_HR_Manager/Page_HRMS/h1_New Manual Time Clock'))
...
WebUI.click(findTestObject('Object Repository/NewManualTimeClock_My_Direct_Report_by_HR_Manager/Page_HRMS/button_Save'))

WebUI.setText(findTestObject('Object Repository/NewManualTimeClock_My_Direct_Report_by_HR_Manager/Page_HRMS/textarea_Comment_comment'), 
    '-To attend Meeting')

WebUI.click(findTestObject('Object Repository/NewManualTimeClock_My_Direct_Report_by_HR_Manager/Page_HRMS/button_Save  View'))
